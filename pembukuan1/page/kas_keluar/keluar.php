        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            $total = 0;
                            $no = 1;
                            $sql = $koneksi->query("select * from pembukuan where jenis ='keluar'");
                        ...
                        <tr>
                            <th colspan="4" style="text-align: center; font-size:20px">Total Pengeluaran</th>
                ...
                if (isset($_POST['simpan'])) {
                    ...
                    $sql = $koneksi->query("insert into pembukuan (kode,keterangan,tgl,jumlah,jenis,keluar)
                    values('$kode','$ket','$tgl','0','keluar','$jml')");
                    if ($sql) {
                ?>
